<template>
  ...
  @blur="show=!show"
  />  
      <label class="input__label" :style="{color:color}">{{label}}</label>
...
export default{
  ...
  props: {
    ...
    label: { type: String , required: false, default: 'Datebox'},
    hint: { type: String, required:false , default:'hint'},
    icon: { type: String, required: false , default: '' },
    placeholder: { type: String, required: false, default: ''},
    color: { type: String , required: false , default: 'DimGray' }
  },
  watch:
  {
    value:function(val){
      this.hint=val + " selected"
    }
  }
}
</script>
